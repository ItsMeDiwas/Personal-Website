...
const projects: Project[] = [
  {
    ...
    category: "AI ORCHESTRATION & PROGRAM MANAGEMENT",
    description: "Orchestrated the architectural rollout of an enterprise-level multi-agent AI assistant. Coordinated a cross-functional engineering team of 12 to deploy LLM pipelines, reducing task latency by 42% and automating core business workflows.",
  ...
  {
    id: "video-creative",
    title: "Cyberpunk Cinematic Reel",
    category: "VIDEO EDITING & CREATIVE MEDIA",
    description: "Designed, directed, and edited a series of high-impact cinematic promotional videos. Developed dynamic rhythm-based pacing cuts, bespoke visual effects, precise color grading, and custom high-fidelity sound design.",
    image: "/images/project_halcyon.png",
    tags: ["Premiere Pro", "After Effects", "Sound Design", "Cinematic Pacing"],
    link: "#",
  },
  {
    id: "full-stack",
    title: "SaaS Analytics & WebGL Dashboard",
    category: "FULL-STACK DEVELOPMENT (THE ROOTS)",
    description: "Engineered a high-throughput real-time data analytics dashboard. Built a robust NestJS backend API, PostgreSQL databases, real-time WebSockets communication, and interactive WebGL chart visualization layers.",
    image: "/images/project_nova.png",
    tags: ["Next.js", "Node.js / NestJS", "Three.js / WebGL", "WebSockets"],
    link: "#",
  },
];
