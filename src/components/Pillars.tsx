...
const pillars: PillarCard[] = [
  {
    ...
    description: "Engineered at the intersection of backend scalability and autonomous cognitive systems. I architect agentic RAG architectures, engineer high-throughput microservices, and orchestrate secure LLM pipelines to deliver high-leverage automated operations.",
    icon: Cpu,
  ...
  },
  {
    ...
    description: "Spearheading high-velocity, cross-functional engineering squads from conceptual design to global deployment. I optimize critical paths, mitigate systemic risks, control capital budgets, and align multi-million dollar stakeholder portfolios using structured PMP frameworks.",
    icon: Briefcase,
  ...
  },
  {
    ...
    description: "Translating digital architecture into high-impact operational logistics. I coordinate complex global supply chains, manage multi-vendor resource allocation networks, design facility blueprints, and scale organizational delivery systems.",
    icon: Globe,
